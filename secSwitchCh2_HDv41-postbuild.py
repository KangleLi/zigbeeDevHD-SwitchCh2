...
def OTA():
    if not '"%PROJECT_DIR%\..\\..\\..\\soft\\SimplicityStudio\\v4\\developer\\sdks\\gecko_sdk_suite\\v2.6\\protocol\\zigbee\\tool\\image-builder\\image-builder-windows.exe" --create "%TARGET_BPATH%.ota" --version 0x41 --manuf-id 0x1254 --image-type 0x0102 --tag-id 0x0000 --tag-file "%TARGET_BPATH%.gbl" --string "EBL secSwitchCh2_HDv41"':
        sys.exit(0)
    print (" ")
    ...
    IMAGE_BUILDER = '"%PROJECT_DIR%\..\\..\\..\\soft\\SimplicityStudio\\v4\\developer\\sdks\\gecko_sdk_suite\\v2.6\\protocol\\zigbee\\tool\\image-builder\\image-builder-windows.exe" --create "%TARGET_BPATH%.ota" --version 0x41 --manuf-id 0x1254 --image-type 0x0102 --tag-id 0x0000 --tag-file "%TARGET_BPATH%.gbl" --string "EBL secSwitchCh2_HDv41"'.replace("\t", "\\t")
